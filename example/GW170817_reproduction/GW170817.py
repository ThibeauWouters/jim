...
# # TODO not sure if has to be interpolated -- seems correct for now though!!!
# print("Testing the shapes for loaded data")
# print(np.shape(H1_data))
# print(np.shape(H1_psd))
# print(np.shape(H1_psd_frequency))
# print(np.shape(H1_frequency))
...
likelihood = HeterodynedTransientLikelihoodFD([H1, L1, V1], prior=prior, bounds=[prior.xmin, prior.xmax], waveform=RippleIMRPhenomD(), trigger_time=gps, duration=T, post_trigger_duration=T/2)
