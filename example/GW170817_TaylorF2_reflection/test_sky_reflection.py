...
# reflect_sky_location_vmap = jax.vmap(reflect_sky_location, in_axes=(None, None, 0, 0, 0, 0))
...
# # Convert ref params to jnp array instead of dict
# ref_params = jnp.array([float(ref_params[p]) for p in ref_params])

# Indices of special initialization:
# Get indices of tc, iota, ra, dec
tc_index = 7
iota_index = 9
ra_index = 11
dec_index = 12
...
truths = np.array([ref_params[p] for p in ref_params])
