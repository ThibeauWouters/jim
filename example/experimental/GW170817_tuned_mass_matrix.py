...
likelihood = HeterodynedTransientLikelihoodFD([H1, L1, V1], prior=prior, bounds=[prior.xmin, prior.xmax], waveform=waveform, trigger_time=gps, duration=T, post_trigger_duration=post_trigger_duration)
...
# TODO change this step size? Check local acceptance
eps = 3e-2
local_sampler_arg = {"step_size": mass_matrix * eps}
...
### TODO merge this old code with above new code
