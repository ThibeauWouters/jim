...
# Prior
prior = Uniform(
    xmin=[1.18, 0.125, -0.05, -0.05,    0.0, -500.0,  1.0, -0.01,        0.0, -1.0,    0.0,        0.0, -1],
    xmax=[1.21,   1.0,  0.05,  0.05, 3000.0,  500.0, 75.0,  0.01, 2 * jnp.pi,  1.0, jnp.pi, 2 * jnp.pi,  1],
    naming=[
        "M_c",
        "q",
        "s1_z", 
...
# TODO get the parameters here after running is done!
...
# Override local sampler arg with tuned mass matrix
eps = 1e-2
local_sampler_arg = {"step_size": tuned_mass_matrix * eps}
