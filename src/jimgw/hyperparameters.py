...
jim_explanation_hyperparameters = {
        ...
        # TODO improve explanation, not sure what this does?
        "num_bins": "(int) Number of bins used in MaskedCouplingRQSpline",
        # TODO wouldn't mass matrix better be a mandatory argument?
...
# jim_hyperparameters_names = list(jim_default_hyperparameters.keys())